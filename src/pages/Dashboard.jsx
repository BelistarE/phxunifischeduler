...
export default function Dashboard() {
  ...
  const [loadingShifts, setLoadingShifts] = useState(true); // New state for loading shifts
  const { user, profile, currentShift, loading } = useAuth();
  useEffect(() => {
    const fetchShifts = async () => {
      setLoadingShifts(true); // Start loading
      ...
      setLoadingShifts(false); // Done loading
    };
    ...
    <div className="h-screen flex flex-col">
      ...
      >
        <div className="max-w-400 w-full h-full p-4 grid grid-cols-1 justify-items-center gap-4 md:grid-cols-2 lg:grid-cols-3 items-start ">
          ...
          <div className="w-full max-w-md">
            {loadingShifts ? (
              <div className="bg-white shadow-md rounded-lg p-4 mt-4 w-full max-w-md justify-center">
                ...
                <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200 flex items-center justify-between">
                  <svg
                    aria-hidden="true"
                    className="inline w-10 h-10 text-gray-200 animate-spin dark:text-gray-400 fill-green-500"
                    viewBox="0 0 100 101"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                  ...
                  <p className="text-lg font-semibold pl-6 p-4  text-gray-800 mr-3">
                    Loading Shifts...
                  </p>
                </div>
              </div>
                  ...
                  {shifts.length === 0 ? (
                    ...
                    <ul className="space-y-4">
                      {shifts.map((shift) => {
                        ...
                        const dayOfWeek = startDate.toLocaleDateString(
                          "en-US",
                          {
                            weekday: "long",
                          }
